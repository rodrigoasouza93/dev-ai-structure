...
- Ler `AGENTS.md` e os `SKILL.md` necessários em `.claude/skills/<nome>/`
...
[Pesquisar as skills em `.claude/skills` que se apliquem a esta especificação e listá-las abaixo:]
